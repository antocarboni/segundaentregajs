    ...
    const table = `
        <div class='tableContainer'>
            ...
            <div class='btn-container'>
                <button class='btnTerminar'>Listo! Quiero pagar.</button>
                <button class='btnVaciar'>Vaciar carrito</button>
            ...
            for (let i = 0; i < carrito.length; i++) {
                ...
                const cart = `
                <tr id=${id}>
                <th><img class='trash' src='./assets/eliminar.png' alt='foto borrar'></th>
